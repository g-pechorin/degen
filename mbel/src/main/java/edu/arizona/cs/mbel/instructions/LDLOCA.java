...
public class LDLOCA extends Instruction implements ShortFormInstruction {
	...
	protected static final int OPCODE_LIST[] = {LDLOCA, LDLOCA_S};
	...
	public LDLOCA(int opcode, edu.arizona.cs.mbel.mbel.ClassParser parse) throws java.io.IOException, InstructionInitException {
