      ...
      if (moreSects){
         ...
         do{
            ...
            for (int i=0;i<method_data_section.nclauses;i++){
               ...
               edu.arizona.cs.mbel.instructions.InstructionHandle te = instructionList.getHandleEndingAt((int)(method_data_section.clauses[i].TryOffset+method_data_section.clauses[i].TryLength));
               ...
               edu.arizona.cs.mbel.instructions.InstructionHandle he = instructionList.getHandleEndingAt((int)(method_data_section.clauses[i].HandlerOffset+method_data_section.clauses[i].HandlerLength));
