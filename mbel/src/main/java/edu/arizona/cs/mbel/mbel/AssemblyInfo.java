...
/** This class contains the extra information that a prime module would have. 
  ...
  */
public class AssemblyInfo implements HasSecurity, edu.arizona.cs.mbel.signature.AssemblyHashAlgorithm, edu.arizona.cs.mbel.signature.AssemblyFlags, edu.arizona.cs.mbel.signature.Culture{
   ...
   /** Makes a new AssemblyInfo with the given information
     ...
     */
   public AssemblyInfo( long hashId, int maj, int min, int bn, int rn, 
                        long flags, byte[] pkey, String name, String culture ){
      HashAlgId = hashId;
      MajorVersion = maj;
      MinorVersion = min;
      BuildNumber = bn;
