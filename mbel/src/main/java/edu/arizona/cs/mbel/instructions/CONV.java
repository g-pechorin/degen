...
public class CONV extends Instruction{
   ...
   protected static final int OPCODE_LIST[] = { CONV_I1, CONV_I2, CONV_I4, CONV_I8, CONV_R4, CONV_R8, 
                                             CONV_U1, CONV_U2, CONV_U4, CONV_U8, CONV_I,  CONV_U, CONV_R_UN };
   ...
   public String getName(){
      String[] str = {  "conv.i1", "conv.i2", "conv.i4", "conv.i8", "conv.u1", "conv.u2",
                        "conv.u4", "conv.u8", "conv.r4", "conv.r8", "conv.i", "conv.u", "conv.r.un"};
   ...
   public CONV(int opcode, edu.arizona.cs.mbel.mbel.ClassParser parse) throws java.io.IOException, InstructionInitException{
