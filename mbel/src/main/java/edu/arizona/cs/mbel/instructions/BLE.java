...
public class BLE extends BranchInstruction{
   ...
   protected static final int OPCODE_LIST[] = {BLE, BLE_S, BLE_UN, BLE_UN_S};
   ...
   public BLE(int opcode, edu.arizona.cs.mbel.mbel.ClassParser parse) throws java.io.IOException, InstructionInitException{
