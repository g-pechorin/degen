...
public class LDARGA extends Instruction implements ShortFormInstruction{
   ...
   protected static final int OPCODE_LIST[] = {LDARGA, LDARGA_S};
   ...
   public LDARGA(int opcode, edu.arizona.cs.mbel.mbel.ClassParser parse) throws java.io.IOException, InstructionInitException{
