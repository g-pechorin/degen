   ...
   private void buildFields(){
      ...
      if (tables[tc.Field]!=null){
         ...
         for (int i=0;i<row.length;i++){
            ...
            edu.arizona.cs.mbel.signature.FieldSignature sig = edu.arizona.cs.mbel.signature.FieldSignature.parse(new edu.arizona.cs.mbel.ByteBuffer(blob), group);
   ...
   private void buildMethods(){
      ...
      if (tables[tc.Method]!=null){
         ...
         for (int i=0;i<row.length;i++){
            ...
            edu.arizona.cs.mbel.signature.MethodSignature sig = edu.arizona.cs.mbel.signature.MethodSignature.parse(new edu.arizona.cs.mbel.ByteBuffer(blob), group);
   ...
   private void buildTypeSpecs(){
      ...
      if (tables[tc.TypeSpec]!=null){
         ...
         for (int i=0;i<row.length;i++){
            ...
            sig = (edu.arizona.cs.mbel.signature.TypeSpecSignature)edu.arizona.cs.mbel.signature.TypeSpecSignature.parse(new edu.arizona.cs.mbel.ByteBuffer(blob), new TypeGroup(typeDefs, typeRefs, typeSpecs));
   ...
   private void buildProperties(){
      ...
      if (tables[tc.Property]!=null){
         ...
         for (int i=0;i<row.length;i++){
            ...
            edu.arizona.cs.mbel.signature.PropertySignature sig = edu.arizona.cs.mbel.signature.PropertySignature.parse(new edu.arizona.cs.mbel.ByteBuffer(blob), group);
   ...
   private void setFieldMarshals(){
      ...
      if (tables[tc.FieldMarshal]!=null){
         ...
         for (int i=0;i<row.length;i++){
            ...
            edu.arizona.cs.mbel.signature.MarshalSignature sig = edu.arizona.cs.mbel.signature.MarshalSignature.parse(new edu.arizona.cs.mbel.ByteBuffer(blob));
      ...
      if (tables[tc.MemberRef]!=null){
         ...
         for (int i=0;i<row.length;i++){
            ...
            if ((blob[0]&0x0F)==edu.arizona.cs.mbel.signature.CallingConvention.FIELD){
               ...
               edu.arizona.cs.mbel.signature.MethodSignature callsig = edu.arizona.cs.mbel.signature.MethodSignature.parse(new edu.arizona.cs.mbel.ByteBuffer(blob), group);
