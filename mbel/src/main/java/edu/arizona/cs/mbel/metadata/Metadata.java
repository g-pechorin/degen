...
public class Metadata {
	...
	public Metadata() {
		...
		ExtraData = 0;
		Length = 12;
		VersionString = new byte[]{(byte) 'v', (byte) '1', (byte) '.', (byte) '0', (byte) '.', (byte) '3', (byte) '7', (byte) '0', (byte) '5', 0, 0, 0};
		Flags = 0;
		Streams = 0;
		stream_headers = null;
	}
	 ...
	 */
	public TableConstants parseTableConstants(edu.arizona.cs.mbel.MSILInputStream in) throws java.io.IOException, edu.arizona.cs.mbel.parse.MSILParseException {
