...
public class InstructionList {
	 ...
	 */
	public InstructionList(edu.arizona.cs.mbel.mbel.ClassParser parse, long CodeSize) throws java.io.IOException, edu.arizona.cs.mbel.parse.MSILParseException {
		this();
