...
public class LDLOC extends Instruction implements ShortFormInstruction{
   ...
   protected static final int OPCODE_LIST[] = {LDLOC, LDLOC_S, LDLOC_0, LDLOC_1, LDLOC_2, LDLOC_3};
   ...
   public LDLOC(int opcode, edu.arizona.cs.mbel.mbel.ClassParser parse) throws java.io.IOException, InstructionInitException{
