...
public class CONV_OVF extends Instruction{
   ...
   protected static final int OPCODE_LIST[] = { CONV_OVF_I1, CONV_OVF_I2, CONV_OVF_I4, CONV_OVF_I8, CONV_OVF_U1, 
                                                CONV_OVF_U2, CONV_OVF_U4, CONV_OVF_U8, CONV_OVF_I,  CONV_OVF_U };
   ...
   public String getName(){
      String str[] = {  "conv.ovf.i1", "conv.ovf.i2", "conv.ovf.i4", "conv.ovf.i8", "conv.ovf.u1",
                        "conv.ovf.u2", "conv.ovf.u4", "conv.ovf.u8", "conv.ovf.i", "conv.ovf.u"};
