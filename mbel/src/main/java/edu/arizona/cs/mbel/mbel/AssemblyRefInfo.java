...
public class AssemblyRefInfo implements edu.arizona.cs.mbel.signature.AssemblyFlags, edu.arizona.cs.mbel.signature.Culture{
   /** A pre-made assembly ref for mscorlib.dll, since it will be used often
     */
   public static final AssemblyRefInfo MSCORLIB = 
      new AssemblyRefInfo(1,0,3300,0,0,
         new byte[]{(byte)0xB7, (byte)0x7A, (byte)0x5C, (byte)0x56, (byte)0x19, (byte)0x34, (byte)0xE0, (byte)0x89}, "mscorlib", "", 
         new byte[]{(byte)0xEA, (byte)0x8F, (byte)0x4C, (byte)0x9D, (byte)0x50, (byte)0x3E, (byte)0x55, (byte)0xB7, (byte)0x21, (byte)0x0A, (byte)0x26, (byte)0x34, (byte)0xD3, (byte)0x88, (byte)0x8C, (byte)0xC6, (byte)0x29, (byte)0xDC, (byte)0xCD}
      );
   ...
   /** Makes an AssemblyRefInfo with the given information
     ...
     */
   public AssemblyRefInfo(int maj, int min, int bn, int rn, long flags, 
                          byte[] pkey, String name, String cult, byte[] hash){
      MajorVersion      = maj;
      MinorVersion      = min;
      BuildNumber       = bn;
      RevisionNumber    = rn;
   ...
   public boolean equals(Object o){
      ...
      if (PublicKeyOrToken.length!=ref.PublicKeyOrToken.length ||
          HashValue.length!=ref.HashValue.length)
         return false;
