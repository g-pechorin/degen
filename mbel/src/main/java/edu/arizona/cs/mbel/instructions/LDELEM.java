...
public class LDELEM extends Instruction{
   ...
   protected static final int OPCODE_LIST[] = { LDELEM_I1, LDELEM_I2, LDELEM_I4, LDELEM_I8, LDELEM_U1, LDELEM_U2,
                                                LDELEM_U4, LDELEM_R4, LDELEM_R8, LDELEM_I,  LDELEM_REF };
   ...
   public String getName(){
      String str[] = {"ldelem.i1", "ldelem.i2", "ldelem.i4", "ldelem.i8", "ldelem.u1",
                      "ldelem.u2", "ldelem.u4", "ldelem.r4", "ldelem.r8", "ldelem.i", "ldelem.ref"};
