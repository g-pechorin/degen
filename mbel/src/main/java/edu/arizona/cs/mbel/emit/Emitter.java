...
public class Emitter{
   private static final byte[] NET_NAME = new byte[]{(byte)'.', (byte)'n', (byte)'e', (byte)'t', 0,0,0,0};
   ...
   public void emitModule(java.io.OutputStream out) throws java.io.IOException{
      ...
      long netSectionRVA = align(pe_module.section_headers[pe_module.section_headers.length-1].VirtualAddress + pe_module.section_headers[pe_module.section_headers.length-1].VirtualSize, pe_header.SectionAlignment);
      ...
      if (!pe_module.section_headers[numSects-1].isNetHeader()){
         ...
         new_headers[netSectionIndex].PointerToRawData = new_headers[netSectionIndex-1].PointerToRawData + new_headers[netSectionIndex-1].SizeOfRawData;
      ...
      long imageSize = align(pe_module.section_headers[numSects-1].VirtualAddress + pe_module.section_headers[numSects-1].VirtualSize, pe_header.SectionAlignment);
