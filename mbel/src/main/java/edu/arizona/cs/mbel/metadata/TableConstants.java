...
public class TableConstants {
	...
	static {
		...
		GRAMMAR[AssemblyRef] = "AssemblyRef:MajorVersion=2,MinorVersion=2,BuildNumber=2,RevisionNumber=2,Flags=4,PublicKeyOrToken=B,Name=S,Culture=S,HashValue=B";
	...
	public static final int[] BITS = {2, 2, 5, 1, 2, 3, 1, 1, 1, 2, 3, 2};
	private static final int[] MASKS = {0x3, 0x3, 0x1F, 0x1, 0x3, 0x7, 0x1, 0x1, 0x1, 0x3, 0x7, 0x3};
   ...
   /*HasConst*/            {Field, Param, Property},
   /*HasCustomAttribute*/  {Method, Field, TypeRef, TypeDef, Param, InterfaceImpl, MemberRef, Module, DeclSecurity, Property, Event, StandAloneSig, ModuleRef, TypeSpec, Assembly, AssemblyRef, File, ExportedType, ManifestResource},
   ...
   /*CustomAttributeType*/ {TypeRef, TypeDef, Method, MemberRef},//, USString},
   /*ResolutionScope*/     {Module, ModuleRef, AssemblyRef, TypeRef}
	...
	public void parseTables(edu.arizona.cs.mbel.MSILInputStream in) throws java.io.IOException {
		...
		for (int i = 0; i < 64; i++) {
			if (c_stream.Counts[i] > 0) { // if table is present
