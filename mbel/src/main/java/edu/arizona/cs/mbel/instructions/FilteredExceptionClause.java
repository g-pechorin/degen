...
public class FilteredExceptionClause extends StructuredExceptionClause{
   ...
   /** Creates a FilteredExceptionClause with the given try, handler, and filter blocks
     ...
     */
   public FilteredExceptionClause(InstructionHandle fs, InstructionHandle fe, InstructionHandle ts, InstructionHandle te, InstructionHandle hs, InstructionHandle he){
      super(ts,te,hs,he);
      filterStart = fs;
      filterEnd = fe;
