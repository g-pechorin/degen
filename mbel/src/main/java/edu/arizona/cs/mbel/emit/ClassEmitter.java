...
public class ClassEmitter{
   ...
   private void buildFields(edu.arizona.cs.mbel.mbel.TypeDef def){
      ...
      edu.arizona.cs.mbel.metadata.GenericTable defTable = (edu.arizona.cs.mbel.metadata.GenericTable)tables[tc.TypeDef].get((int)def.getTypeDefRID()-1);
   ...
   private void buildMethodBodies(edu.arizona.cs.mbel.mbel.TypeDef def){
      ...
      for (int i=0;i<methodlist.length;i++){
         ...
         if (body!=null){
            edu.arizona.cs.mbel.metadata.GenericTable methodTable = (edu.arizona.cs.mbel.metadata.GenericTable)tables[tc.Method].get((int)methodlist[i].getMethodRID()-1);
