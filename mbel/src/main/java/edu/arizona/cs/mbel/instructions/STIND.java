...
public class STIND extends UnalignedPrefixInstruction{
   ...
   protected static final int OPCODE_LIST[] = {STIND_I1, STIND_I2, STIND_I4, STIND_I8, STIND_R4, STIND_R8, STIND_I, STIND_REF};
   ...
   public String getName(){
      String str[] = {"stind.i1", "stind.i2", "stind.i4", "stind.i8",
                      "stind.r4", "stind.r8", "stind.i", "stind.ref"};
