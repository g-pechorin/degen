...
public class BGT extends BranchInstruction {
	...
	protected static final int OPCODE_LIST[] = {BGT, BGT_S, BGT_UN, BGT_UN_S};
	...
	public BGT(int opcode, edu.arizona.cs.mbel.mbel.ClassParser parse) throws java.io.IOException, InstructionInitException {
