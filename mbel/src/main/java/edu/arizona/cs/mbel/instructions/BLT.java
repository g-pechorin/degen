...
public class BLT extends BranchInstruction{
   ...
   protected static final int OPCODE_LIST[] = {BLT, BLT_S, BLT_UN, BLT_UN_S};
   ...
   public BLT(int opcode, edu.arizona.cs.mbel.mbel.ClassParser parse) throws java.io.IOException, InstructionInitException{
