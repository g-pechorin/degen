...
/** 
 * Defines a polygon shape on top of a #TextureRegion for minimising pixel drawing. Can either be 
 * constructed through a .psh file from an external editor or programmatically through a list of vertices
 * defining a polygon.
 * 
 * THIS STUFF IS WIP
 * 
...
public class PolygonRegion {
   ...
   // pixel coordinates relative to source image.
	...
	/**
	 * Creates a PolygonRegin by triangulating the polygon coordinates in vertices and calculates uvs 
	 * based on that. TextureRegion can come from an atlas.
	 * @param region the region used for drawing
    ...
    * 
    * ------------
    * // Triangulated vertices data (x, y) in pixel coordinates with origin bottom-left, y-up
    * v 230.0, 230.0, ...
    * // UVs with origin top-left 
    * u 0.23, 0.123, ...  
    * -------------
    * 
