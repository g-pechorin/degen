...
public class Assets {
	...
	public static void load () {
		...
		atlas = new TextureAtlas(Gdx.files.classpath(textureFile), Gdx.files.classpath(textureDir));
		loadTextures();
		createAnimations();
		loadFonts();
		loadSounds();
	...
	private static float calculatePixelDensity () {
		FileHandle textureDir = Gdx.files.classpath("data/textures");
	...
	private static void loadFonts () {
		...
		scoreFont = new BitmapFont(Gdx.files.classpath(fontDir + SCORE_FONT), false);
		textFont = new BitmapFont(Gdx.files.classpath(fontDir + TEXT_FONT), false);
		flyupFont = new BitmapFont(Gdx.files.classpath(fontDir + FLYUP_FONT), false);
	...
	private static Sound[] loadSounds (String dir) {
		FileHandle dh = Gdx.files.classpath("data/sounds/" + dir);
	...
	private static Sound loadSound (String filename) {
		return Gdx.audio.newSound(Gdx.files.classpath("data/sounds/" + filename));
	}
